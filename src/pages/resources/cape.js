  ...
  render() {
    return (
      <>
        <Layout>
          <SEO
            title="CAPE Past Paper and MCQ Solutions"
            description="Download free CAPE MCQ solutions and other materials to help you pass your exams. Share these resources with your friends."
          />
          <Helmet>
            <meta
              name="keywords"
