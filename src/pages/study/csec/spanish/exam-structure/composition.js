  ...
  render() {
    return (
      <>
        <Layout>
          <SEO
            title="Composition - CSEC Spanish"
            description=""
          ...
          <SpanishLayout active="composition">
            ...
            <BrowserView>
              <Breadcrumb>
                ...
                <BreadcrumbItem active>Composition</BreadcrumbItem>
              </Breadcrumb>
            </BrowserView>
