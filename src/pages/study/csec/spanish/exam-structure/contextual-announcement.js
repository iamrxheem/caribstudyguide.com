  ...
  render() {
    return (
      <>
        <Layout>
          <SEO
            title="Contextual Announcement - CSEC Spanish"
            description=""
          ...
          <SpanishLayout active="contextual-announcement">
            ...
            <BrowserView>
              <Breadcrumb>
                ...
                <BreadcrumbItem active>Contextual Announcement</BreadcrumbItem>
              </Breadcrumb>
            </BrowserView>
            ...
            <MobileView>
              <Breadcrumb>
                ...
                <BreadcrumbItem active>Contextual Ann.</BreadcrumbItem>
              </Breadcrumb>
            </MobileView>
