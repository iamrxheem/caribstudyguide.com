  ...
  render() {
    return (
      <>
        <Layout>
          <SEO
            title="Reading Comprehension - CSEC Spanish"
            description=""
          ...
          <SpanishLayout active="reading-comprehension">
            ...
            <BrowserView>
              <Breadcrumb>
                ...
                <BreadcrumbItem active>Reading Comprehension</BreadcrumbItem>
              </Breadcrumb>
            </BrowserView>
            ...
            <MobileView>
              <Breadcrumb>
                ...
                <BreadcrumbItem active>Comprehension</BreadcrumbItem>
              </Breadcrumb>
            </MobileView>
