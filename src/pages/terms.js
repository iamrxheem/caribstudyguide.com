...
const Page = () => (
  <>
    <Layout>
      <SEO title="" description="This note describes our terms of use." />
      ...
      <Container>
        ...
        <h5>Preview your Terms of Use</h5>
        <br />

        <p>
          The CXC Online Study Guide website located at https://www.cxcguide.com
          is a copyrighted work belonging to CXC Study Guide. Certain features
        ...
        <p>
          <strong>Subject to these Terms.</strong> cxcguide.com grants you a
        ...
        <p>
          cxcguide.com reserves the right to change, suspend, or cease the Site
          with or without notice to you. You approved that cxcguide.com will not
          be held liable to you or any third-party for any change, interruption,
          or termination of the Site or any part.
        </p>

        <p>
          <strong>No Support or Maintenance.</strong> You agree that
          cxcguide.com will have no obligation to provide you with any support
        ...
        <p>
          ...
          by cxcguide.com or cxcguide.com’s suppliers. Note that these Terms and
          ...
          rights expressed in Section 2.1. cxcguide.com and its suppliers
        ...
        <p>
          ...
          provided, sponsored or endorsed by cxcguide.com. Because you alone are
          responsible for your User Content, you may expose yourself to
          liability. cxcguide.com is not obliged to backup any User Content that
        ...
        <p>
          You hereby grant to cxcguide.com an irreversible, nonexclusive,
        ...
        <p>
          If you provide cxcguide.com with any feedback or suggestions regarding
          the Site, you hereby assign to cxcguide.com all rights in such
          Feedback and agree that cxcguide.com shall have the right to use and
          fully exploit such Feedback and related information in any manner it
          believes appropriate. cxcguide.com will treat any Feedback you provide
          to cxcguide.com as non-confidential and non-proprietary.
        </p>

        <p>
          You agree to indemnify and hold cxcguide.com and its officers,
          ...
          Content. cxcguide.com reserves the right to assume the exclusive
          ...
          consent of cxcguide.com. cxcguide.com will use reasonable efforts to
        ...
        <p>
          ...
          control of cxcguide.com, and cxcguide.com is not responsible for any
          Third-Party Links & Ads. cxcguide.com provides access to these
        ...
        <p>
          ...
          cxcguide.com will not be responsible for any loss or damage incurred
          as the result of any such interactions. If there is a dispute between
          you and any Site user, we are under no obligation to become involved.
        </p>

        <p>
          You hereby release and forever discharge the cxcguide.com and our
        ...
        <p>
          <strong>Cookies and Web Beacons.</strong> Like any other website, CXC
          Study Guide uses ‘cookies’. These cookies are used to store
        ...
        <p>
          ...
          cxcguide.com and our suppliers expressly disclaim any and all
        ...
        <p>
          To the maximum extent permitted by law, in no event shall cxcguide.com
          ...
          of, or incapability to use the site even if cxcguide.com has been
        ...
        <p>
          ...
          Account from our live databases. cxcguide.com will not have any
        ...
        <p>
          cxcguide.com respects the intellectual property of others and asks
        ...
        <p>
          ...
          It is part of your contract with cxcguide.com and affects your rights.
        ...
        <p>
          ...
          service provided by the cxcguide.com that cannot be resolved
          ...
          and the cxcguide.com, and to any subsidiaries, affiliates, agents,
        ...
        <p>
          ...
          the cxcguide.com should be sent to: Kingston, Jamaica. After the
          Notice is received, you and the cxcguide.com may attempt to resolve
          the claim or dispute informally. If you and the cxcguide.com do not
        ...
        <p>
          ...
          settlement offer that the cxcguide.com made to you prior to the
          initiation of arbitration, the cxcguide.com will pay you the greater
        ...
        <p>
          <strong>Time Limits.</strong> If you or the cxcguide.com pursues
        ...
        <p>
          ...
          cxcguide.com, and the dispute will not be consolidated with any other
        ...
        <p>
          ...
          should arise between you and the cxcguide.com in any state or federal
          court in a suit to vacate or enforce an arbitration award or
          otherwise, YOU AND THE cxcguide.com WAIVE ALL RIGHTS TO A JURY TRIAL,
        ...
        <p>
          ...
          will survive the termination of your relationship with cxcguide.com.
        </p>

        <p>
          <strong>Small Claims Court.</strong> Nonetheless the foregoing, either
          you or the cxcguide.com may bring an individual action in small claims
          court.
        </p>
        ...
        <p>
          ...
          technical data acquired from cxcguide.com, or any products utilizing
          such data, in violation of the United States export laws or
          regulations.
        </p>

        <p>
          cxcguide.com is located at the address in Section 10.8. If you are a
        ...
        <p>
          ...
          you and cxcguide.com use electronic means, whether you use the Site or
          send us emails, or whether cxcguide.com posts notices on the Site or
          communicates with you via email. For contractual purposes, you (a)
          consent to receive communications from cxcguide.com in an electronic
          form; and (b) agree that all terms and conditions, agreements,
          notices, disclosures, and other communications that cxcguide.com
        ...
        <p>
          ...
          law. Your relationship to cxcguide.com is that of an independent
          ...
          without cxcguide.com’s prior written consent, and any attempted
          assignment, subcontract, delegation, or transfer in violation of the
          foregoing will be null and void. cxcguide.com may freely assign these
        ...
        <p>Email: contact@cxcguide.com</p>
      </Container>
    </Layout>
  </>
)
